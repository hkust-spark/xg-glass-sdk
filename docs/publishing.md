...
- `io.github.hkust-spark:universal:0.1.0`
- `io.github.hkust-spark:core:0.1.0`
- `io.github.hkust-spark:core-android:0.1.0`
- `io.github.hkust-spark:app-contract:0.1.0`
- `io.github.hkust-spark:device-rokid:0.1.0`
- `io.github.hkust-spark:device-rayneo-installer:0.1.0`
- `io.github.hkust-spark:device-rayneo-runtime:0.1.0`
- `io.github.hkust-spark:device-simulator:0.1.0`
- `io.github.hkust-spark:device-omi:0.1.0`
- `io.github.hkust-spark:device-meta:0.1.0`
- `io.github.hkust-spark:device-android-xr:0.1.0`
- `io.github.hkust-spark:device-frame-flutter:0.1.0`

`device-meta` is intentionally published as an optional artifact. The aggregate
`universal` artifact does not depend on it, so consumers can resolve
`io.github.hkust-spark:universal:0.1.0` without access to the Meta GitHub
