...
dependencies {
    ...
    implementation("io.github.hkust-spark:xgglass-universal-full:0.2.0")
    // xg:device:all:end
    ...
    implementation("io.github.hkust-spark:xgglass-device-rokid:0.2.0")
    // xg:device:rokid:end
    // xg:device:rayneo:begin
    implementation("io.github.hkust-spark:xgglass-device-rayneo-installer:0.2.0")
    implementation("io.github.hkust-spark:xgglass-device-rayneo-runtime:0.2.0")
    // xg:device:rayneo:end
    ...
    // xg:device:frame:end
    // xg:device:omi:begin
    implementation("io.github.hkust-spark:xgglass-device-omi:0.2.0")
    // xg:device:omi:end
    // xg:device:even:begin
    implementation("io.github.hkust-spark:xgglass-device-even:0.2.0")
    // xg:device:even:end
    // xg:device:inmo:begin
    implementation("io.github.hkust-spark:xgglass-device-inmo-runtime:0.2.0")
    // xg:device:inmo:end
