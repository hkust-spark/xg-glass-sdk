...
Run `xg-glass validate --devices <device>` to generate a filtered validation app, install and launch it, guide a tester through the supported hardware checks, and write a paste-ready Markdown report for [issue #63](https://github.com/hkust-spark/xg-glass-sdk/issues/63). The runner does not automate BLE pairing or glasses gestures; it uses generated-app logcat markers when available and prompts for manual PASS/FAIL/SKIP otherwise.
